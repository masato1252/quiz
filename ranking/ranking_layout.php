...
function bg_change(rank) {
    ...
    $('tr#row'+rank).css('background-color', '#FFEBCD');
    if(rank==10){
        $('tr#row1').css('background-color', 'White');
    }else{
        $('tr#row'+(rank+1)).css('background-color', 'White');
    }
...
<div id="r_title_box"><?php printf("総合ランキング"); ?></div>
...
<?php
    for($i=1; $i<=10; $i++){
?>
<div class="nameBox" id="<?php printf("row".$c); ?>">
    <div class="rank" id="<?php printf("row_r".$c); ?>">1</div>
    <div class="team" id="<?php printf("row_d".$c); ?>">A</div>
    <div class="name" id="<?php printf("row_n".$c); ?>">あああああ</div>
    <div class="num" id="<?php printf("row_c".$c); ?>">10問</div>
<div class="time" id="<?php printf("row_t".$c); ?>">01:30.050</div>
    <div class="clear"></div>
</div>
<?php
    }
